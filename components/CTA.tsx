...
export default function CTA() {
    return (
        <section className="relative py-24 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-teal-50 via-white to-emerald-50 dark:bg-black dark:from-transparent dark:to-transparent">
                <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-30 dark:opacity-20 mix-blend-multiply dark:mix-blend-soft-light"></div>
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 text-center">
                ...
                >
                    ...
                    <p className="mb-10 text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                        Begin with local JSON files for rapid prototyping, then switch to
                        MongoDB or PostgreSQL for production without changing your code.
                    </p>
